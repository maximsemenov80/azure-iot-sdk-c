# Azure IoT Provisioning Client Sample: Using Certificate Signing Requests.

## Build instructions

1. Modify `.\prov_dev_client_ll_x509_csr_sample.c`: update the `id_scope`, `registration_id`, 
...
# At the root of the repository
cd build
./provisioning_client/samples/prov_dev_client_ll_x509_csr_sample/prov_dev_client_ll_x509_csr_sample
```
