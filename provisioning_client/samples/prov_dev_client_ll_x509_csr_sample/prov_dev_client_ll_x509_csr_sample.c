...
static const char* certificate_signing_request = "<base64-encoded DER certificate signing request>";
static const char* certificate_signing_request_private_key =
"-----BEGIN PRIVATE KEY-----\n"
"MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQg6s92gNq7JlPpI9Cu\n"
"..."
"EcGgB76X130F1Mjd10Pa==\n"
"-----END PRIVATE KEY-----\n";
...
int main(void)
{
    ...
    // Set the X509 certificates in the DPS client
        ...
        (Prov_Device_LL_SetOption(user_ctx.handle, PROV_CERTIFICATE_SIGNING_REQUEST, certificate_signing_request) != PROV_DEVICE_RESULT_OK) ||
        (Prov_Device_LL_SetOption(user_ctx.handle, PROV_CERTIFICATE_SIGNING_REQUEST_PRIVATE_KEY, certificate_signing_request_private_key) != PROV_DEVICE_RESULT_OK)
        )
    {
